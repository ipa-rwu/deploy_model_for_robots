...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>deployModel</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class DeployModelExample {
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(DeployModelPackage.eNS_URI, 
			 DeployModelPackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				...
				Yaml root = DeployModelFactory.eINSTANCE.createYaml();
